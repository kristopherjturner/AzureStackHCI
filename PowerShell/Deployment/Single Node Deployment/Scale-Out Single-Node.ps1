<#
Name: Scale Out Single-Node Deployment.ps1
...
if ($NetATC) {
    ...
    if ((Get-CimInstance -ClassName win32_computersystem -CimSession $ClusterNode).Model -eq "Virtual Machine") {
        ...
        Import-Module NetworkATC
        Add-NetIntent -ClusterName $ClusterName -Name StorageIntent -Storage -AdapterName $AdapterNames -Verbose #-StorageVlans 1,2
    }
